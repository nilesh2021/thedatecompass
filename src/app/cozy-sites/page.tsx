        ...
        >
          ...
          >
            ...
            <p className="mt-6 border border-cream/10 bg-ink-soft px-4 py-3 text-center text-xs leading-relaxed text-fog">
              ...
              commission when you visit a platform through our links. All
              listed services are third-party providers for adults 18+.
            </p>
          </div>
        </section>
